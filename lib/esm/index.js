...
export var Ocean = forwardRef(function (_a, ref) {
    ...
    var water = useState(function () { return (new Water(geometry, __assign({ textureWidth: 512, textureHeight: 512, waterNormals: normalMap, sunDirection: new Vector3(), sunColor: 0xffffff, waterColor: 0x001e0f, distortionScale: 3.7, fog: false }, options))); })[0];
    useImperativeHandle(ref, function () { return water; });
    useEffect(function () {
    ...
    return (_jsx("group", __assign({}, props, { children: _jsx("primitive", { object: water, "rotation-x": -Math.PI / 2 }) })));
});
